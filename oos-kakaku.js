...
(function (root) {
  ...
  /* ══════════════════════════════════════════════════════════════════════
     🔒 単価は【いつでも価格マスタから】　★2026-09-16 ひろみさん確定
     ──────────────────────────────────────────────────────────────────────
     ひろみさん：「**価格マスタから単価は使って！ 伝票は間違っていることがあるから、
     　　　　　　今のやり方で合ってたの**」

     2026-09-16、RTの発注伝票に書かれた単価（例 7,110円）を
     そのまま書類に使う入口（unitPriceFixed）を足しかけました。
     　→ **ひろみさんの指示で取りやめ、元に戻しました。**
     　　 理由：RTの伝票の単価は【間違っていることがある】。
     　　 　　 うちの正しい単価は【価格マスタ】にある。

     ★「行に書いてある単価をそのまま使う」入口を、もう一度作らないでください。
     　（unitPriceFixed／useLinePrice／priceOverride など、名前を変えても同じことです）
     ★人が画面で単価を直せるのは【その画面の中の話】です。
     　書類に出る単価は、いつでもこの関数が価格マスタから引いた数字です。
     見張り：tests/test_rt_denpyou_tanka.js
     ══════════════════════════════════════════════════════════════════════ */
