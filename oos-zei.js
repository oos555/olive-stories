...
(function(global){
  ...
  var FOOD_GROUPS = [
    ...
    'その他オイル',
    'カップオイル',
    /* ★2026-09-10 ひろみさん確認「ぜんぶ8%」。
       この2つは、あとから名簿に増えたグループで、ここに入っていませんでした。
       そのため 本番で ARM500・ARM3L・TGR100 の3品が【10%】で計算されていました。
       　アルモニア   … オリーブオイル（ボトル／バッグインボックス）
       　唐辛子オイル … 食品
       ★オイル・食品のグループを名簿に新しく作ったら、必ずここにも足してください。
       　足さないと【黙って10%】で請求書が出ます（安全側に倒してあるため）。 */
    'アルモニア',
    '唐辛子オイル'
  ];
