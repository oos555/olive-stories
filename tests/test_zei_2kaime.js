...
console.log('\n■ Ｄ 倉庫Ｄの納品書に送料・倉庫手数料');
{
  ...
  /* ══════════════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════════════ */
  /* 住所が空 → その他 880円（税込）→ 税抜 800円 が自動で入ります */
  t('Ｄ 料金をえらんでいない注文には、決めごとの送料800円が入る', h2.indexOf('800') >= 0, true);
  t('Ｄ そのとき「別途申し受けます」とは書かない', h2.indexOf('別途申し受けます') >= 0, false);
  ...
  /* 合計＝商品9,500 ＋8%760 ＋ピックアップ0 ＋送料800 ＋10%80 ＝ 11,140 円
     ★手で計算した数を直に書いています。式に直さないでください
     　（式にすると、親が壊れたときに見張りも同じように壊れて気づけません）。 */
  t('Ｄ そのとき合計は 11,140 円（商品＋自動で入った送料）', h2.indexOf('11,140') >= 0, true);
