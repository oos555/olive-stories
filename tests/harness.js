...
function makeSandbox(extra){
  ...
  /* ══════════════════════════════════════════════════════════════════════
     ★2026-09-12 書類の決めごと oos-shorui-kimari.js も、どのテストでも入れます。
     ──────────────────────────────────────────────────────────────────────
     入れていなかったため、書類の親を動かす見張りが【古い動きのまま】通っていました。
     　・単位（本・缶・個）が 名簿の欄だけになる
     　・「必ず載る枠」（ピックアップ料金・送料）が出ない
     　・「請求書だけならPDFを作らない」という古い決めごとで通る
     本物のアプリは index.html / pickup.html が読み込んでいるので、
     【砂場だけが本物とちがう】状態でした。2026-09-12 にそろえました。
     ★消さないでください。消すと、また古い動きで通る見張りに戻ります。
     ══════════════════════════════════════════════════════════════════════ */
  try{ vm.runInContext(read('oos-shorui-kimari.js'), ctx); }catch(e){}
