...
const FILES = [
  ...
  ['test_hinagata.js','お客様に渡すお届け先リスト：原本が空のときだけリンクを渡す（2026-09-25）'],
  ['test_koukai.js','外に出してよいの印（統合マスタＮの名簿・お届け先リストに効く／2026-09-25）'],
  ['test_tani_erabu.js','統合マスタＮ：単位表示を▼で選ぶ・小口の合計本数なし・ログは使っていない（2026-09-25）'],
  ['test_mkt_neta.js','マーケ：ネタは社長専用スプシに1行ずつ・アプリは分類ごと最新1件・投稿プランはそのまま（2026-09-25）'],
