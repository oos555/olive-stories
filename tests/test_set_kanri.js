...
/* ══════════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════════ */
{
  /* ★2026-09-14 業務フロー説明書（gyomu_flow.html）は、ひろみさんの指示でやめました。
     「内容が違い過ぎるし、こうやって消していけばまた作り直しになるから消して」
     そのため、この⑩の見張りは【統合マスタＮだけ】になりました。
     ★失った見張り：説明書側の言い方のそろい／古い「SKU*本数のカンマ区切り」の残り。
       説明書を作り直すときは、ここも戻してください。 */
  [['統合マスタＮ', M]].forEach(pair => {
