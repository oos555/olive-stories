...
/* ★2026-09-13 ひろみさん指示で［📥 もう一度 発注書に送る］は廃止。
   二重よけは【止める仕掛け】が残っているかで見ます（ボタンの字ではなく中身）。 */
has('⑥受注Ａ：送ったあとは、もう一度送るボタンを出さない', idxSrc, 'もう一度発注書を貼る以下、全部いらない');
has('⑥受注Ａ：もう一度押しても二重にならない（止める仕掛け）', idxSrc, 'すでに取込済です');
...
/* ★2026-09-04夜 ひろみさん指示：同梱書類は「あり/なし」だけ＋スプシから印刷のお願い */
has('⑯同梱書類は あり/なし だけ', goSrc, 'あり（スプレッドシートからプリントアウトして同梱をお願いします）');
/* ★2026-09-04 ひろみさん確認：リンク先は倉庫Ｄ（大チェックの画面）に変更 */
has('⑯押せるチェックは倉庫Ｄへ', goSrc, 'pickup.html');
