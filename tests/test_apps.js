...
try{
  ...
  /* ══════════════════════════════════════════════════════════════════
     ...
     倉庫ピッキング手数料と送料は書類にだけ出るもので、発注書スプシには
  ...
  /* ══════════════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════════════ */
  /* ★2026-09-13 ひろみさん指示で、注文番号は【約束ごとＳの案件管理番号】のまま出します。
     　TK- / OS1- / OS2- / FT- / IT- は【出してよい】ので、この一覧から外しました。
     　出してはいけないのは、RT・バサラの記号と、区分そのものの言葉です。
     ★「RTは私たちの隠語だから使ったら絶対にダメ」（2026-08-19）は、そのまま生きています。 */
  var NGWORDS = ['RT','RTGC','卸','バサラ','不良','特価','特別提供','定価','アイポーター','BA-'];
  var DOCCASES = [
  ...
  /* ══════════════════════════════════════════════════════════════
     🔴 社印　★2026-09-12 ひろみさん確定：【どの書類でも必ず押す】
     ──────────────────────────────────────────────────────────────
     ひろみさん：「PDFにまた社印が抜けてる」
     前（2026-08-19）：「一般のお客様には押さない」← 廃止しました。
     　その判定は o.customerType !== 'general' と【英語】でくらべていて、
     　日本語の「定価」には効かず、押されていたのは区分が空の注文だけでした。
     ★「一般には出さない」に戻さないでください（2026-09-12 ひろみさん確定）。
     ══════════════════════════════════════════════════════════════ */
  eq('⑤ 一般のお客様にも印鑑（社判）を押す', h.indexOf('alt="社判"') >= 0, true);
